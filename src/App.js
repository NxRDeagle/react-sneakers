...
function App() {
  ...
  React.useEffect(() => {
    async function fetchData() {
      const cartResponse = await axios.get('https://63bc4615fa38d30d85c2bceb.mockapi.io/cart');
      const favoritesResponse = await axios.get('https://63c3a57da9085635752ac471.mockapi.io/favorites');
