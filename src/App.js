...
function App() {
  ...
  React.useEffect(() => {
    axios.get('https://63bc4615fa38d30d85c2bceb.mockapi.io/items').then((res) => {
      setItems(res.data);
    });
    axios.get('https://63bc4615fa38d30d85c2bceb.mockapi.io/cart').then((res) => {
      setCartItems(res.data);
    });
    axios.get('https://63c3a57da9085635752ac471.mockapi.io/favorites').then((res) => {
